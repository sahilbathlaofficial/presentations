...
# set_callback :user_added, :before_sub_user
  set_callback :user_added, :around, :after_sub_user
  ...
  def after_sub_user
    puts "before adding the user: #{@users.inspect}\n"
    yield
    puts "after adding the user: #{@users.inspect}\n"
    yield
    puts "after 2nd yield adding the user: #{@users.inspect}\n"
  end
